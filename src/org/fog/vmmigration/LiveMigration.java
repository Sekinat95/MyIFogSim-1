...
//		implementar aqui
//		pensar que, temos um periodo de migragao sem queda de conexao. e um periodo com a queda. 
//		inicia a migrar a partir de um ponto, e quando a conexao cair, iniciar a migração do restante dos dados nao só da memoria.
//		seria possivel combinar migração ao vivo de containers? ou somente maquina inteira? seria mais uma cenario, num total de 4?
	}
