...
public final class MaxAndMin {
	...
	public static final int MAX_DISTANCE = 1000; //Max Ap coverage distance - It should modify
	...
	public static final int MAX_SIMULATION_TIME = 1000*60*1500; //30 minutes
