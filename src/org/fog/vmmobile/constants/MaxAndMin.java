...
public final class MaxAndMin {
	...
	public static final int MAX_DISTANCE = 2500; //Max Ap coverage distance - It should modify
	...
	public static final int MAX_SIMULATION_TIME = (int)(1000*60*180); //30 minutes 
